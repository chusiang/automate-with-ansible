...
取得 Nginx, MySQL 和 PHP 的 Roles 之後，接下來就剩 TestLink 了，接下來就讓凍仁來展示怎麼用 Roles 來**簡化**複雜的 Playbooks 吧！
...
1. 執行完畢後，我們可用瀏覽器 (Browsers) 開啟 http://192.168.33.10 進入 TestLink 的網站。
